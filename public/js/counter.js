...
function Counter (tag) {
	...
	this.setValue = function setValue (newValue) {
		...
		digits[0].src = PATH + Math.floor(value / 100 % 10) + ".gif";
		digits[1].src = PATH + Math.floor(value / 10 % 10) + ".gif";
		digits[2].src = PATH + Math.floor(value % 100 % 10) + ".gif";
	};
